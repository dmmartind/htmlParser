...
$this->openBody( [], FALSE );
$this->openSpan( ['class'=>"regular-price"], FALSE );
$this->closeSpan( ['class'=>"regular-price", 'text'=>""], FALSE );
$this->strong( %s, FALSE );
$this->openSpan( ['class'=>"price"], FALSE );
$this->closeSpan( ['class'=>"price", 'text'=>""], FALSE );
$this->closeDiv( FALSE );
$this->closeaTag( ['class'=>"price", 'text'=>"", 'text'=>""], FALSE );
$this->closeDiv( FALSE );
$this->closeDiv( FALSE );
